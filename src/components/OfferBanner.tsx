      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 py-8">
          ...
          <div className="text-center md:text-right">
            <div className="font-heading text-5xl md:text-7xl text-primary animate-pulse mb-2">
              FIRST CLASS FREE
            </div>
            <a
              href="#contact"
              className="inline-flex items-center justify-center px-10 py-4 bg-gradient-gold text-primary-foreground font-heading text-lg tracking-widest rounded-lg glow-gold-intense hover:scale-105 transition-transform duration-300"
            >
              CLAIM NOW
            </a>
          </div>
